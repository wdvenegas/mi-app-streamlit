...
def mostrar_cabecera():
    ...
    with col1:
        try:
            st.image("F:\WDVL\Escuela_Global\Programacion-CienciaDatos_IA\Desarrollo_de_Aplicaciones_Analiticas_con_Streamlit\sesion_02\C02_logo_empresa.jpg", width=120)
        except:
...
# --- FUNCIONES DE DATOS ---
FILE_PATH = r"F:\WDVL\Escuela_Global\Programacion-CienciaDatos_IA\Desarrollo_de_Aplicaciones_Analiticas_con_Streamlit\Sesion_04\C03_Encuesta.csv"
